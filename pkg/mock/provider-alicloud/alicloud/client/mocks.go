...
// Source: github.com/gardener/gardener-extension-provider-alicloud/pkg/alicloud/client (interfaces: ClientFactory,ECS,STS,SLB,VPC,OSS,RAM,ROS,NLB)
...
func (m *MockNLB) DescribeZones(arg0 *nlb.DescribeZonesRequest) (*nlb.DescribeZonesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeZones", arg0)
	ret0, _ := ret[0].(*nlb.DescribeZonesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DescribeZones indicates an expected call of DescribeZones.
func (mr *MockNLBMockRecorder) DescribeZones(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeZones", reflect.TypeOf((*MockNLB)(nil).DescribeZones), arg0)
}

// GetNLBAvailableZones mocks base method.
func (m *MockNLB) GetNLBAvailableZones(arg0 string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNLBAvailableZones", arg0)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNLBAvailableZones indicates an expected call of GetNLBAvailableZones.
func (mr *MockNLBMockRecorder) GetNLBAvailableZones(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNLBAvailableZones", reflect.TypeOf((*MockNLB)(nil).GetNLBAvailableZones), arg0)
}
